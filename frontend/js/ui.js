...
showOverlay('loading', 'Updating App & Syncing Data...');

// 1. Wipe frontend LocalStorage and Session caches so the next load fetches fresh
...
// 4. Force App Version Cache clear by aggressively unregistering SW
...
// 5. Clear Browser Cache Storage entirely to dump old JS/HTML/CSS assets
if ('caches' in window) {
    try {
